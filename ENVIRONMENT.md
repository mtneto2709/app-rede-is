...
WHATSAPP_API_TOKEN=          # token permanente de um System User (não o de teste, que expira em 24h)
WHATSAPP_PHONE_NUMBER_ID=    # em WhatsApp > API Setup no painel da Meta
WHATSAPP_TEMPLATE_NAME=      # nome exato do template de autenticação aprovado
